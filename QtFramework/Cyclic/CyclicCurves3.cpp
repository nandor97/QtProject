...
namespace cagd
{
    ...
    CyclicCurve3::CyclicCurve3(GLuint n, GLenum data_usage_flag): LinearCombination3(0.0, TWO_PI, 2 * n + 1, data_usage_flag),_n(n),_c_n(_CalculateNormalizingCoefficient(n)),_lambda_n(TWO_PI/(2 * n + 1))
    {
