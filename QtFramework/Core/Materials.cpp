...
Material::Material(
    const Color4& front_ambientf,
    const Color4& front_diffusef,
    const Color4& front_specularf,
    const Color4& front_emissivef,
    GLfloat front_shininessf,

    const Color4& back_ambientf,
    const Color4& back_diffusef,
    const Color4& back_specularf,
    const Color4& back_emissivef,
...
{
	return _front_ambient.a() == 0.0 && _front_diffuse.a() == 0.0 && _front_emissive.a() == 0.0 &&
           _front_specular.a() == 0 && _back_ambient.a() == 0.0 && _back_diffuse.a() == 0.0
            && _back_emissive.a() == 0.0 && _back_specular.a() == 0.0;
}
//-----------------------------------------------------------------
// brass
